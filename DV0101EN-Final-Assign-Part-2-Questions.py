...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        ...
        return [
            html.Div([R_chart1, R_chart2], style={'width': '50%', 'display': 'inline-block'}),
            html.Div([R_chart3, R_chart4], style={'width': '50%', 'display': 'inline-block'})
            ]
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                html.Div([Y_chart1, Y_chart2], style={'width': '50%', 'display': 'inline-block'}),
                html.Div([Y_chart3, Y_chart4], style={'width': '50%', 'display': 'inline-block'})
                ]
    else:
        return None
